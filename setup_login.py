...
def setup_new_login():
    ...
    # 프로필 이름 입력 받기
    profile_name = input("사용할 프로필 이름을 입력하세요 (예: mini_goyamedia_feed): ").strip()
    
    # 0_insta_login.txt 파일 생성
    login_file_path = os.path.join(current_dir, "0_insta_login.txt")
